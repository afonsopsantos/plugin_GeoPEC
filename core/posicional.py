...
/***************************************************************************
 ...
 Avaliação da acurácia posicional de dados geoespaciais através de normas 
 brasileiras como: Decreto n. 89817 / ET-CQDG, NBR-13.1333, INCRA e ANM
 Diversas análises estatisticas: detecção de outlier, teste de normalidade, 
 teste de tendência.
 Evaluation of the positional accuracy of geospatial data using Brazilian 
 standards such as: Decree No. 89817 / ET-CQDG, NBR-13.1333, INCRA and ANM
 Statistical analyses: outlier detection, normality test, bias test.
...
# Importando as funções implementadas em functions/  "normas_pec.py" e "relatorio.py"
# Importing the functions implemented in functions/  "normas_pec.py" e "relatorio.py"
from ..functions.normas_pec import *
from ..functions.relatorio import *


class posicional:
    """Implementação do da avaliação da acurácia posicional utilizando feições pontuais"""
    """Implementation of positional accuracy assessment using point features"""
    ...
    def __init__(self, iface):
        ...
        # Creating processing control attributes
        ...
        # Creating a dictionary to control the display of chart windows    
        self.graphs_open = {
                'dispersao_2d': False,
                'dispersao_z': False,
                'tendencia_en': False,
        ...
        # Creating a memory check attribute for the graph images.
    ...
    def obt_data(self):
        ...
        # Checking if there are at least 2 layers in the comboBox
        ...
        # Verificando se as camadas tem pelo menos 3 pontos, pois muitas estatisticas necessitam de pelo menos 3 pontos
        # Checking if the layers have at least 3 points, as many statistics require at least 3 points.
        ...
        # Returning the data, and code 4 - success
        return data, 4
    
    def atualiza_imagem(self, imagem):
        """ Método que atualiza a imagem da tendência, a partir do valor da variancia circular"""
        """ Method that updates the trend image, based on the value of the circular variance"""
    ...
    def showVarCircular(self,op):
        ...
        """This method makes the labels in the trend tab visible or invisible, referring to circular variance
            If op is true, it displays the labels; if it is false, it does not require the labels"""
    ...
    def showNormalidade(self, op):
        ...
        """This method enables or disables the labels on the normality tab, according to the processing option"""
    ...
    def atualizaOutlier(self, metodo, dados_2D, dados_Z):
        ...
        """This method updates the graphical interface of the outliers tab"""


        # Obtendo a opção de processamento referente as normas e a aba de outlier
        # Obtaining the processing option related to standards and the outlier tab
        op = self.op_norma
    ...
    def outlier(self, dados, op): 
        """Este método realiza a análise de outliers com base nos dados de discrepâncias (dados) e na opção de planimetria ou altimetria (op)"""
        """This method performs outlier analysis based on discrepancy data (dados) and the option of planimetry or altimetry (op)"""
        
        # Obtendo o método para análise de outliers, 3sigma ou boxplot  
        # Getting the method for outlier analysis, 3sigma or boxplot
        ...
        if opcao == 0: 
            ...
            # Getting the factor and class from the 3sigma method
            ...
            # Obtaining the scale to be used in the 3 sigma test
            if op ==1: # Planimetria
            ...
            # Applying the outlier detection method
            ...
            # Returning outliers, method and tolerance
    ...
    def travar(self):
        ...
        """This method disables tabwidgets"""
    ...
    def atualizar_cor_linha(self, index, row, out):
        ...
        """This method updates the discrepancy table row color"""
        ...
        if index == 1:
            ...
            # Cycling through all columns in the row
            for col in range(self.dlg.tableWidget_11.columnCount()):
                ...
                # Changing the item color to the desired color
                if item: # Casos em que são itens | Cases in which they are items
                    item.setBackground(brush)         
                else: # Casos em que temos o comboBox de excluir |  Cases in which we have the delete comboBox
                    widget = self.dlg.tableWidget_11.cellWidget(row, col)
                    widget.setStyleSheet("background-color: rgb(235, 235, 235);")
        
        # Entra no else caso o usuário não tenha escolhido excluir o ponto de checagem
        # Enter else if the user has not chosen to delete the checkpoint
        else:
            # Entra no if se a discrepância em questão for outlier
            # Enter if if the discrepancy in question is an outlier
            if  out:
                # Cor desejada, ciano
                # Desired color, gray
                color = QColor(100, 255, 255)   
                brush = QBrush(color)
    ...
    def atulizaEtCQDG(self,op,resultados):
        ...
        """This method updates the graphical interface of the ETCQDG tab, and has as parameters the option of 2D, Z or 3D, and the results"""

        # Desempacotando os resultados 2D e Z
        # Unpacking 2D and Z results
        result2d = resultados[0]
        resultZ = resultados[1]
        
        # Atualizando a interface gráfica da aba da ET-CQDG
        # Updating the ET-CQDG tab graphical interface
        ...
        if (op ==0): 
            ...
            # Changing the second table
            
            # Alterando a porcentagem de discrepâncias menores que o PEC e se o RMS foi menor que o EP
            # Changing the percentage of discrepancies smaller than the PEC and if the RMS was smaller than the EP
            ...
            # Changing the result that appears in the table
            ...
            # changing the visibility of the tabwidgets
            ...
            # setting the tabs that will be current
            ...
            # It will only not be "precise" if there is no classification, i.e., it falls into the else
            ...
            else: # Sem classificação | no classification
        ...
        #Z
            ...
            # It will only not be precise if it falls into the else, i.e., "no classification"
        ...
        #2D e Z    
            ...
            # changing the final result for altimetry and planimetry
            ...
            # Changing the planimetry result
    ...
    def configuracao_Interface(self):
        ...
        self.dlg.tableWidget_11.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)   
        self.dlg.tableWidget_2.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        
        self.dlg.tableWidget_3.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_4.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_5.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_6.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        
        self.dlg.tableWidget_19.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_20.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_21.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_22.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        
        self.dlg.tableWidget_7.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_9.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        
        self.dlg.tableWidget_12.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.dlg.tableWidget_14.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
    ...
    def abrir_caminho_relatorio(self):
        ...
        """Execution of the button to define the location and name of the report's pdf file."""
    ...
    def is_valid_path(self, path):
        ...
        """This method checks whether the path entered by the user is valid"""

        # Verifica se o diretório onde o arquivo será salvo existe
        # Checks if the directory where the file will be saved exists
    ...
    def getVariaveis_relatorio(self):
        ...
        """This method obtains the variables entered by the user to place in the report"""
        ...
        # Verificando se o caminho inserido é válido, se for válido retorna True e as variáveis, se não, retorna False
        # Checking if the entered path is valid, if it is valid it returns True and the variables, if not, it returns False
    ...
    def getNC_testes_relatorio(self):
        ...
        """This method obtains the confidence level from the Shapiro Wilk and Student's t tests."""

        # obtendo o nivel de confiança do teste shapiro-wilk 
        # obtaining the confidence level of the shapiro-wilk test 
        ...
        # obtendo o nnivel de confiança do teste t de student 
        # obtaining the confidence level from the student's t test
        ...
        # Returning the confidence level of tests
    ...
    def get_Outliers_relatorio(self, data):
        ...
        """Ethis method obtains the outliers to be inserted in the report"""
        ...
        if (op==0) or (op==3) or (op==6) or (op==7): 
            ...
            # Para os processamentos diferentes da NBR13133
            # For processing other than NBR13133
            try:   
                # Obtendo a classe do teste 3sigma
                # Getting the 3sigma test class
                classe = self.classe_3sigma
                if classe ==0:
            ...
            # Creating the dictionary with the outliers
            ...
            # Retornando o dicionario com os outliers
        ...
        #Z    
            ...
            # Returning the dictionary with the outliers
            return dict_outliers
        ...
        #2D e Z    
            ...
            try:           
                ...
                # Getting class from 3sigma method
                classe = self.classe_3sigma
    ...
    def getMetodologia_relatorio(self):
        ...
        """This method obtains the processing methodology chosen by the user, Santos et al, or just the decree"""
        
        # Metodologia Santos et al
        # The methodology of Santos et al
    ...
    def getAcuracia_relatorio(self):
        ...
        """This method performs the accuracy analysis according to the methodology Santos et al"""

        # Realizando o teste de acurácia 2D  
        # Performing the 2D accuracy test  
        ...
        # Performing the Z accuracy test    
    ...
    def getImagens_relatorio(self):
        ...
        """This method obtains images from the graphs to be inserted into the report"""
        ...
        # Obtaining images according to the processing option
        
        #2D
        if (op==0) or (op==3) or (op==6) or (op==7): 
            
            # Definindo um dicionário com as imagens
            # Defining a dictionary with images
            ...
            # Returning the dictionary with the images
            return dict_imagens
        ...
        #2D e Z    
            ...
            # Retornando o dicionário com as imagens
            # Returning the dictionary with images
            return dict_imagens
    ...
    def variaveis_relatorio(self):
        ...
        """This method packages the variables that will be used to generate the report in a dictionary python"""

        # Obtendo as variáveis inseridas pelo usuário
        # Getting variables entered by the user
        ...
        # Checking whether the variables entered by the user are valid, if they are, a dictionary is created for the report
        if valid:
            ...
            # Obtaining the variables referring to NBR 13133
            ...
            # Defining some variables for the ETCQDG and ANM processing cases
            if (op==0) or (op==1) or (op==2) or (op==7)or (op==8) or (op==9) : 
                self.var_atende_INCRA_relatorio = 'nao definido'
                self.var_artificial_INCRA_relatorio = 'nao definido'
                self.var_natural_INCRA_relatorio = 'nao definido'
                self.var_inacessivel_INCRA_relatorio = 'nao definido'
            ...
            # Quando não processa a ANM
            # When not process the ANM
            if not ((op ==7) or (op==8) or (op==9)): 
            ...
            dict_var = { 'var_produto' : variaveis['var_produto'],
                               ...
                               'var_resp_tecnico' : variaveis['var_resp_tecnico'],
                                ...
                                'var_normalidade_2D' : var_normalidade_2D, 
                                ...
                                'var_escala_2D' : self.escala_2D_relatorio, 
                                'var_escala_Z' : self.escala_Z_relatorio,
                                'var_NBR' : dict_NBR,
        ...
        # mensagem de erro para variaveis inválidas
    ...
    def generateRelatorio (self):
        ...
        # Obtaining the dictionary with the report variables and the variable that defines whether the data is valid or not
        dict_var, var_true = self.variaveis_relatorio()
        
        # Se os dados são válidos, entra no IF e tenta gerar o relatório
        # If the data is valid, enter the IF and try to generate the report        
        if var_true:
            # Tentando gerar o relatório   
            # Trying to generate the report        
            try: 
                fProcessamento_relatorio(dict_var)
                self.show_messagebox_erro('sucesso', 'Relatório gerado com sucesso!')

            # Erro por estar aberto um relatório com mesmo nome
            # Error due to a report with the same name being open
            ...
            # Outro tipo de erro ao gerar o relatório
            # Another type of error when generating the report
            except Exception as e: 
                self.show_messagebox_erro('erro', f'Não foi possível gerar o relatório! ERRO: {e}')
            
            # Fechando os objetos de memória
            # Closing memory objects
            finally:  
                # Fechar os objetos BytesIO em dict_var
                # Close BytesIO objects in dict_var
                ...
                # Rechecking and closing remaining objects in the tracking list
                for obj in self.bytes_io_objects:
                    if not obj.closed:
                        obj.close()
                               
                # Verificando novamente se todos os objetos BytesIO foram fechados 
                # Checking again if all BytesIO objects have been closed
                for obj in self.bytes_io_objects:
                    if not obj.closed:
    ...
    def visibleLabels_resumo(self):
        ...
        """This method disables all labels in the summary and report tabs."""
    ...
    def resumo_ETCQDG (self):
        ...
        """This method updates the summary and report tab when processing is of the ET-CQDG standard"""
        ...
        # Obtaining processing options, standard and methodology (Santos et al or decree)
        op = self.op_norma
        opc = self.opc
        ...
        if (op==0): 
            ...
            if (opc == 1): 
                ...
                # two extra labels for the scale
        ...
        # 2D e Z        
            ...
            if (opc == 1): 
				...
				# four extra labels for the scale
                self.dlg.label_161.setVisible(True)
                self.dlg.label_164.setVisible(True)
				...
				# Changing the result of the labels  - Z          
    ...
    def resumo_ANM(self):
        ...
        """This method updates the summary and report tab when processing according to the ANM standard"""
        ...
        # Obtendo a opção de processamento
        # Obtaining the processing option
        op = self.op_norma
        ...
        # 2D e Z
            ...
            # quatro labels amais para a escala
            # four more labels for the scale
            self.dlg.label_161.setVisible(True)
            self.dlg.label_164.setVisible(True)
            self.dlg.label_165.setVisible(True)
            self.dlg.label_166.setVisible(True)
    ...
    def resumo_NBR(self):
        ...
        """This method updates the summary and report tab when processing according to the NBR 13133 standard"""
    ...
    def resumo_INCRA(self):
        ...
        """This method updates the summary and report tab when processing according to INCRA standards"""
        ...
        self.dlg.label_76.setVisible(True)
        self.dlg.label_119.setVisible(True)
        # dois labels a mais para a escala
        # two more labels for the scale
        self.dlg.label_161.setVisible(True)
        self.dlg.label_164.setVisible(True)    
    ...
    def atualizaInterface_resumo(self):
        ...
        """This method updates the summary and report tab; it is the primary method for updating the tab, based on the standard being processed"""

        # Obtem a opção de processamento e deixa todas as labels invisiveis
        # Enables the processing option and makes all labels invisible
        op = self.op_norma
        self.visibleLabels_resumo()
        
        # Atualiza a interface gráfica com base na opção de processamento 
        # Updates the graphical interface based on the processing option
        #ET CDQG  
        ...
        # Setting the summary and report tab as the current tab
    ...
    def run(self):
        ...
        if not self.connections_made:
            ...
            # Conecta os botões para seus métodos
            # Connect the buttons to your methods.
            self.carregaVetor()
